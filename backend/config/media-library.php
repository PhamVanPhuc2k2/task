...
return [
     ...
     *
     * Ép kiểu int: `env()` trả về chuỗi "30" khi biến có mặt trong .env, và
     * App\Support\Media\MediaUrl đọc giá trị này qua Config::integer() — vốn
     * ném lỗi nếu gặp chuỗi. Mặc định 5 phút quá ngắn cho một trang mở lâu,
     * nên .env.example đặt 30.
     */
    'temporary_url_default_lifetime' => (int) env('MEDIA_TEMPORARY_URL_DEFAULT_LIFETIME', 30),
